...
export default function CyberSpyHunterPage() {
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-800 text-white font-sans items-center justify-center p-4">
      <div className="text-center">
        <Shield className="h-24 w-24 text-gray-400 mx-auto mb-8 animate-pulse [filter:drop-shadow(0_0_8px_theme(colors.gray.400))_drop-shadow(0_0_16px_theme(colors.gray.500))]" />
        <h1 className="text-5xl sm:text-6xl font-extrabold mb-6 leading-tight">
          Cyber<span className="text-transparent bg-clip-text bg-gradient-to-r from-gray-400 to-gray-600">Spy Hunter</span>
        </h1>
        <p className="text-xl sm:text-2xl text-gray-300 mb-10 max-w-xl mx-auto">
          Advanced cybersecurity monitoring and threat detection system
        </p>
        <div className="bg-gray-800/60 p-8 rounded-xl shadow-2xl border border-gray-700/50 max-w-md mx-auto">
          ...
          <p className="text-gray-400 mb-6">
            We're developing advanced cybersecurity tools to help protect your digital assets.
            Stay tuned for powerful threat detection capabilities!
          </p>
          <Link href="/">
            <Button
              variant="outline"
